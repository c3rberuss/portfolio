...
import 'package:megalibreria/src/blocs/map/bloc.dart';
...
import 'package:megalibreria/src/presentation/widgets/change_address_dialog.dart';
          ...
          BlocBuilder<MapBloc, MapState>(
            ...
            builder: (BuildContext context, MapState state) {
              return IconButton(
                ...
                onPressed: state.validLocation ? () async {
