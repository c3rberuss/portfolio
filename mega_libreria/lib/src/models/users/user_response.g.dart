...
class _$UserResponse extends UserResponse {
  ...
  _$UserResponse._({this.message, this.code, this.data}) : super._() {
    if (message == null) {
  ...
  int get hashCode {
    return $jf(
        $jc($jc($jc(0, message.hashCode), code.hashCode), data.hashCode));
  }
    ...
    try {
      _$result = _$v ??
          new _$UserResponse._(
              message: message, code: code, data: _data?.build());
    } catch (_) {
