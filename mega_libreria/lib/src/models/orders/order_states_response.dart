...
abstract class OrderStatesResponse implements Built<OrderStatesResponse, OrderStatesResponseBuilder> {
  int get code;
  String get message;
  ...
  factory OrderStatesResponse([void Function(OrderStatesResponseBuilder) updates]) = _$OrderStatesResponse;
