    ...
    if (object.body != null) {
      result
        ...
        ..add(serializers.serialize(object.body,
            specifiedType: const FullType(CategoriesPagination)));
    }
    return result;
  }
...
class _$CategoriesResponse extends CategoriesResponse {
  ...
  @override
  final CategoriesPagination body;
  ...
  _$CategoriesResponse._({this.code, this.message, this.body}) : super._() {
    if (code == null) {
...
class CategoriesResponseBuilder
  ...
  CategoriesPaginationBuilder _body;
  CategoriesPaginationBuilder get body =>
      _$this._body ??= new CategoriesPaginationBuilder();
  set body(CategoriesPaginationBuilder body) => _$this._body = body;
