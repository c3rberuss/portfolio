...
abstract class DepartmentsResponse implements Built<DepartmentsResponse, DepartmentsResponseBuilder> {
  int get code;
  String get message;
  @nullable
  ...
  factory DepartmentsResponse([void Function(DepartmentsResponseBuilder) updates]) = _$DepartmentsResponse;
